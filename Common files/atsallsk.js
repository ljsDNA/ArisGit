...
function graphicdialogs(g_ooutfile, bcheckuserdialog)
{
  ...
  if (bcheckuserdialog.value) {
    ...
    while (binput == false) {
      ...
      userdialog.TextBox(200, 132, 60, 20, "Text0", 0, "Používateľská");
    ...
    if (! (nuserdlg1 == 0)) {
      ...
      // (No page settings for HTML output)
        ...
        while (binput == false) {
          ...
          userdialog.TextBox(120, 67, 40, 20, "Text0", 0, "Hore");
          ...
          userdialog.TextBox(120, 127, 40, 20, "Text4", 0, "Vľavo");
          ...
          userdialog.DropListBox(280, 67, 220, 70, g_sPaperFormat, "VAR_PaperFormat", 0, "Formát stránky");
