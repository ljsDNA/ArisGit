...
// Colors
const COL_HEADING      = getColorByRGB(  5,  99, 219); // #0563db
...
function outTitlePage(p_oOut, p_sFont, p_sTitle, p_sDate, p_aDetails, p_sLabelTitlePage) {
    ...
    p_oOut.BeginTable(100, [new java.lang.Double(99.99), new java.lang.Double(.01)], Constants.C_TRANSPARENT, Constants.C_TRANSPARENT, Constants.FMT_LEFT, 0);
    // Logo
    p_oOut.TableRow();
    ...
    var nSizeMultiplier = 10; // BLUE-25234 Use multiplier value '10' (was '1000' before)
