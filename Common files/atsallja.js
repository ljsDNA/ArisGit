...
function graphicdialogs(g_ooutfile, bcheckuserdialog)
{
  ...
  if (bcheckuserdialog.value) {
    ...
    while (binput == false) {
      ...
      userdialog.GroupBox(7, 120, 686, 85, "拡大縮小");
      userdialog.TextBox(200, 132, 60, 20, "Text0", 0, "ユーザー定義");
...
function GraphicDialogsFunc_Dlg3(dlgitem, action, suppvalue)
{
  ...
  switch(action) {
    case 1:
      ...
      g_tPaperFormat[4] = new tPaperFormatType("レター", 216, 280);             // Letter
      g_tPaperFormat[5] = new tPaperFormatType("リーガル", 216, 356);              // Legal
