...
function graphicdialogs(g_ooutfile, bcheckuserdialog)
{
  ...
  if (bcheckuserdialog.value) {
    ...
    while (binput == false) {
      ...
      userdialog.Text(10, 25, 460, 15, "Výber ukoncíte stiskem tlacítka OK.");
      userdialog.GroupBox(7, 50, 686, 55, "Barva");
      userdialog.OptionGroup("options1");
      userdialog.OptionButton(20, 65, 580, 15, "Barevný");
      userdialog.OptionButton(20, 80, 580, 15, "Cernobíle");
      userdialog.GroupBox(7, 120, 686, 85, "Merítko");
      userdialog.TextBox(200, 132, 60, 20, "Text0", 0, "Uživatelem definované");
      ...
      userdialog.OptionButton(20, 182, 660, 15, "Merítko modelu");
      userdialog.GroupBox(7, 220, 686, 55, "Oříznout");
      userdialog.OptionGroup("options4");
      userdialog.OptionButton(20, 235, 580, 15, "Oríznout objekty na okraji");
      userdialog.OptionButton(20, 250, 580, 15, "Nechat presáhnout objekty na okraji");
      userdialog.OKButton();
        ...
        if ( !(isNaN(dlg.getDlgText("Text0"))) ) {
          ...
          if (nscalevalue.value >= 10 && nscalevalue.value <= 400) {    // BLUE-10197 Adapted to the allowed values in Designer 
            binput = true;
                        ...
                        Dialogs.MsgBox("Zadejte hodnotu mezi 10 a 400.", 0, "Sestava");
          }
    ...
    if (! (nuserdlg1 == 0)) {
      ...
      // (No page settings for HTML output)
        ...
        while (binput == false) {
          ...
          userdialog.Text(20, 70, 100, 15, "Nahore");
          userdialog.TextBox(120, 67, 40, 20, "Text0", 0, "Nahore");
          userdialog.Text(170, 70, 25, 15, "mm");
          userdialog.Text(20, 100, 100, 15, "Dole");
          userdialog.TextBox(120, 97, 40, 20, "Text2", 0, "Dole");
          userdialog.Text(170, 100, 25, 15, "mm");
          userdialog.Text(20, 130, 100, 15, "Vlevo");
          userdialog.TextBox(120, 127, 40, 20, "Text4", 0, "Vlevo");
          userdialog.Text(170, 130, 25, 15, "mm");
          userdialog.Text(20, 160, 100, 15, "Vpravo");
          userdialog.TextBox(120, 157, 40, 20, "Text5", 0, "Vpravo");
          userdialog.Text(170, 160, 25, 15, "mm");
          userdialog.GroupBox(270, 49, 240, 180, "Velikost stránky");
          userdialog.DropListBox(280, 67, 220, 70, g_sPaperFormat, "VAR_PaperFormat", 0, "Velikost stránky");
          userdialog.Text(280, 100, 100, 14, "Šírka");
          userdialog.TextBox(380, 97, 40, 21, "Text1", 0, "Šírka");
          userdialog.Text(430, 100, 30, 14, "mm");
          userdialog.Text(280, 130, 100, 14, "Výška");
          userdialog.TextBox(380, 127, 40, 21, "Text3", 0, "Výška");
...
function extensionselect(sextension, bcheckuserdialog)
{
  ...
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "Nebylo možné vytvorit pro formát.");
  userdialog.Text(10, 25, 460, 15, "Vyberte novou možnost. Výber ukoncíte stiskem tlacítka OK.");
...
function changeexgraph(g_ooutfile, bcheckuserdialog)
{
  ...
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "Nebylo možné vytvorit obrázek pro formát.");
  userdialog.Text(10, 25, 460, 15, "Vyberte novou možnost. Výber ukoncíte stiskem tlacítka OK.");
