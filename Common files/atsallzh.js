...
function graphicdialogs(g_ooutfile, bcheckuserdialog)
{
  ...
  if (bcheckuserdialog.value) {
    ...
    while (binput == false) {
      ...
      userdialog.TextBox(200, 132, 60, 20, "Text0", 0, "用户定义");
    ...
    if (! (nuserdlg1 == 0)) {
      ...
      // (No page settings for HTML output)
        ...
        while (binput == false) {
          ...
          userdialog.TextBox(120, 67, 40, 20, "Text0", 0, "顶");
          userdialog.Text(170, 70, 25, 15, "毫米");
          userdialog.Text(20, 100, 100, 15, "底");
          userdialog.TextBox(120, 97, 40, 20, "Text2", 0, "底");
          ...
          userdialog.DropListBox(280, 67, 220, 70, g_sPaperFormat, "VAR_PaperFormat", 0, "纸张格式");
          userdialog.Text(280, 100, 100, 14, "宽度");
          userdialog.TextBox(380, 97, 40, 21, "Text1", 0, "宽度");
          userdialog.Text(430, 100, 30, 14, "毫米");
          userdialog.Text(280, 130, 100, 14, "高度");
          userdialog.TextBox(380, 127, 40, 21, "Text3", 0, "高度");
