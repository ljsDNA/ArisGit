...
function graphicdialogs(g_ooutfile, bcheckuserdialog)
{
  ...
  if (bcheckuserdialog.value) {
    ...
    while (binput == false) {
      ...
      userdialog.TextBox(200, 132, 60, 20, "Text0", 0, "معرّف من قبل المستخدم");
...
function extensionselect(sextension, bcheckuserdialog)
{
  ...
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "لا يمكن استخدام خيار الإخراج المحدد لإنشاء التقرير.");
  ...
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "تنسيق نص منسق (* .rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "ملف HTML (* .htm)");
  userdialog.OptionButton(20, 95, 580, 15, "Text File ‏(*.txt)");
  userdialog.OptionButton(20, 110, 580, 15, "مستند Word (* .doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
...
function changeexgraph(g_ooutfile, bcheckuserdialog)
{
  ...
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "لا يمكن استخدام خيار الإخراج المحدد لإنشاء تقرير بالرسم.");
  userdialog.Text(10, 25, 460, 15, "الرجاء تحديد تبويب التحليل. انقر فوق 'موافق' لإنهاء التحديد.");
  userdialog.GroupBox(7, 50, 686, 67, "خيارات المخرجات");
  userdialog.OptionGroup("options1");
  userdialog.OptionButton(20, 65, 580, 15, "تنسيق نص منسق (* .rtf)");
  userdialog.OptionButton(20, 80, 580, 15, "ملف HTML (* .htm)");
  userdialog.OptionButton(20, 95, 580, 15, "مستند Word (* .doc)");
  userdialog.OKButton();
  userdialog.CancelButton();
