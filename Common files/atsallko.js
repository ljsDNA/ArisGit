...
function graphicdialogs(g_ooutfile, bcheckuserdialog)
{
  ...
  if (bcheckuserdialog.value) {
    ...
    while (binput == false) {
      ...
      // %GRID:10,7,1,1
      userdialog.Text(10, 10, 460, 15, "모델 그래픽을 어떻게 표시하시겠습니까?");
      ...
      userdialog.TextBox(200, 132, 60, 20, "Text0", 0, "사용자 정의");
        ...
        if ( !(isNaN(dlg.getDlgText("Text0"))) ) {
          ...
          if (nscalevalue.value >= 10 && nscalevalue.value <= 400) {    // BLUE-10197 Adapted to the allowed values in Designer 
            binput = true;
                        ...
                        Dialogs.MsgBox("10에서 400 사이의 숫자 값을 입력하세요.", 0, "보고서");
          }
...
function extensionselect(sextension, bcheckuserdialog)
{
  ...
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "선택한 출력 옵션은 보고서를 만드는 데 사용할 수 없습니다.");
  userdialog.Text(10, 25, 460, 15, "다른 옵션을 선택하세요. 확인을 클릭하여 선택을 종료합니다.");
...
function changeexgraph(g_ooutfile, bcheckuserdialog)
{
  ...
  // %GRID:10,7,1,1
  userdialog.Text(10, 10, 650, 15, "선택한 출력 옵션은 그래픽이 포함된 보고서를 만드는 데 사용할 수 없습니다.");
  userdialog.Text(10, 25, 460, 15, "다른 옵션을 선택하세요. 확인을 클릭하여 선택을 종료합니다.");
