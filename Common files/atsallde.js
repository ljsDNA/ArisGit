...
function graphicdialogs(g_ooutfile, bcheckuserdialog)
{
  ...
  if (bcheckuserdialog.value) {
    ...
    while (binput == false) {
      ...
      userdialog.TextBox(200, 132, 60, 20, "Text0", 0, "Benutzerdefiniert");
    ...
    if (! (nuserdlg1 == 0)) {
      ...
      // (No page settings for HTML output)
        ...
        while (binput == false) {
          ...
          userdialog.TextBox(120, 67, 40, 20, "Text0", 0, "Oben");
          userdialog.Text(170, 70, 25, 15, "mm");
          userdialog.Text(20, 100, 100, 15, "Unten");
          userdialog.TextBox(120, 97, 40, 20, "Text2", 0, "Unten");
          ...
          userdialog.DropListBox(280, 67, 220, 70, g_sPaperFormat, "VAR_PaperFormat", 0, "Papierformat");
          userdialog.Text(280, 100, 100, 14, "Breite");
          userdialog.TextBox(380, 97, 40, 21, "Text1", 0, "Breite");
          userdialog.Text(430, 100, 30, 14, "mm");
          userdialog.Text(280, 130, 100, 14, "Höhe");
          userdialog.TextBox(380, 127, 40, 21, "Text3", 0, "Höhe");
