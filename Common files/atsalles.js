...
function graphicdialogs(g_ooutfile, bcheckuserdialog)
{
  ...
  if (bcheckuserdialog.value) {
    ...
    while (binput == false) {
      ...
      userdialog.TextBox(200, 132, 60, 20, "Text0", 0, "Definido por el usuario");
    ...
    if (! (nuserdlg1 == 0)) {
      ...
      // (No page settings for HTML output)
        ...
        while (binput == false) {
          ...
          userdialog.TextBox(380, 97, 40, 21, "Text1", 0, "Ancho");
          userdialog.Text(430, 100, 30, 14, "mm");
          userdialog.Text(280, 130, 100, 14, "Alto");
          userdialog.TextBox(380, 127, 40, 21, "Text3", 0, "Alto");
