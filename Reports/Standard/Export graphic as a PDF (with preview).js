...
function optionsDialog() {  
    ...
    this.getPages = function() {
        ...
        iDialogTemplate.DropListBox(20, 115, 250, 20, aPaperFormatNames, "LIST_FORMAT", 0, getString("DLG_USERDEFINED"));
    ...
    this.calculatePreviewPageSize = function(model, modelAttributes){
        ...
        var coef     = modelAttributes.graphicsZoom/10;
    ...
    this.fitModelGraphicsToDialogElement = function(aGraphic, picElement){
		...
		if(modelWidth > Constants.MODEL_CANVAS_MAXWIDTH || modelHeight > Constants.MODEL_CANVAS_MAXHEIGHT) return null;
